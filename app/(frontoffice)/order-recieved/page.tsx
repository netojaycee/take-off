...
//   } = useGetUserOrderByRefQuery(reference);
//   if (isLoading) {
//     return (
...
//     );
//   }
//   // http://localhost:3001/order-recieved?trxref=0zos6nwj0e&reference=0zos6nwj0e
    ...
    <div className="px-2 md:px-10 my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <div className="flex justify-between">
            <span className="font-medium">Date:</span>
            <span className="font-bold">{mergedData.paidAt}</span>
          </div>
        </div>
        <div>
          <div className="flex justify-between">
